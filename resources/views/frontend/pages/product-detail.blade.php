                        ...
                        <div class="wsus__pro_details_text">
                            ...
                            <div class="wsus__pro_det_share">
                                ...
                                <ul class="d-flex">
                                    ...
                                    <li><a class="whatsapp" href="javascript:void(0);"><i
                                                class="fab fa-whatsapp"></i></a></li>
                                    <li><a class="instagram" href="javascript:void(0);"><i class="fab fa-instagram"></i></a>
                                    </li>
                                </ul>
                            </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-xl-6 col-xxl-7 col-md-6 mt-4 mt-md-0">
                                                    <div class="wsus__pro_det_vendor_text">
                                                        ...
                                                        <p><span>Store Name:</span> {{ $product->vendor->shop_name }}
                                                        </p>
