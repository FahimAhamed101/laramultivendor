            ...
            <div class="row">
                <div class="col-xl-8 col-lg-7">
                    <div class="wsus__check_form">
                        <h5>Shipping Details <a href="#" data-bs-toggle="modal" data-bs-target="#exampleModal">Add New
                                Address</a></h5>
                        <div class="row">
    ...
    <script>
        $(document).ready(function () {
            ...
            $('.shipping_method').on('click', function () {
                ...
                let totalAmount = currentTotalAmount + shipping_fee;

                $('#shipping_method_id').val($(this).val());
                $('#shipping_fee').text("{{ $settings->currency_icon }}" + shipping_fee);
            ...
            $('#submitCheckoutForm').on('click', function (e) {
                ...
                if ($('#shipping_method_id').val() === "") {
                    flasher.error('Shipping method is required!');
                } else if ($('#shipping_address_id').val() === "") {
                    flasher.error('Shipping address is required!');
                } else if (!$('.agree_term').prop('checked')) {
                    flasher.error('You have to agree website terms and conditions!');
                } else {
                    $.ajax({
