                    ...
                    for (let item in data) {
                        ...
                        html += `<li id="mini-cart_${product.rowId}">
                                            <div class="wsus__cart_img">
                                                <a href="{{ url('product-detail') }}/${product.options.slug}"><img src="{{ asset('/')}}${product.options.image}" alt="${product.name}" class="img-fluid w-100"></a>
                                                <a class="wsis__del_icon remove-sidebar-product" data-id="${product.rowId}" href="javascript:void(0);"><i class="fas fa-minus-circle"></i></a>
                                            </div>
