            ...
            <div class="col-xl-5 col-3 col-md-3 col-lg-6">
                <div class="wsus__call_icon_area">
                    ...
                    <ul class="wsus__icon_area">
                        ...
                        <li><a class="wsus__cart_icon" href="javascript:void(0);"><i
    ...
    <div class="wsus__mini_cart">
                ...
                <li id="mini-cart_{{ $sidebarProduct->rowId }}">
                    <div class="wsus__cart_img">
                        <a href="#"><img src="{{ asset($sidebarProduct->options->image) }}"
                                         alt="{{ $sidebarProduct->name }}" class="img-fluid w-100"></a>
                        <a class="wsis__del_icon remove-sidebar-product" data-id="{{ $sidebarProduct->rowId }}"
        ...
        <div class="mini_cart_actions {{ Cart::content()->count() === 0 ? 'd-none' : '' }}">
            ...
            <div class="wsus__minicart_btn_area">
                ...
                <a class="common_btn" href="javascript:">Checkout</a>
            </div>
        </div>
    </div>
